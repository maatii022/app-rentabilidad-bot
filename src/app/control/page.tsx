      ...
      <div className="space-y-2">
        <div className="flex items-center gap-3">
          <button
            ...
            className={`group relative shrink-0 overflow-hidden rounded-full border transition-all duration-300 ${
              open
            ...
            <div className="relative flex h-full items-center justify-center">
              <span
                className={`absolute whitespace-nowrap text-sm font-medium text-zinc-200 transition-all duration-300 ${
                  open
                    ? "translate-x-[-12px] scale-90 opacity-0"
          ...
          >
            <div className="flex flex-wrap gap-2">
              {hasOptions ? (
                ...
                <p className="text-xs text-amber-200/80 whitespace-nowrap">
